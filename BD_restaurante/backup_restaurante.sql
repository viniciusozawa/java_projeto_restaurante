...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `feedback_codFeedback` int NOT NULL,
  PRIMARY KEY (`codCliente`,`feedback_codFeedback`),
  KEY `fk_cliente_feedback_idx` (`feedback_codFeedback`)
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `cargoFuncionario` enum('Garçom','Gerente','Limpeza') NOT NULL,
